        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    @if (empty($setting->company_name) && empty($setting->company_address) && empty($setting->phone_one))
                      <span style="color: #fff; font-size: 18px;">Adicione as informaçõs através do dashboard</span>
                    @else
                          ...
                          <ul class="toggle-footer" style="">
                              <li class="media">
                                  ...
                                  <div class="media-body">
                                      <p>{{ $setting->company_name }} <br>
                                          {{ $setting->company_address }}</p>
                                  </div>
                              </li>
                              <li class="media">
                                  <div class="pull-left"> <span class="icon fa-stack fa-lg"> <i
                                  ...
                                  @if ($setting->phone_one != null || $setting->phone_two != null)
                                      <div class="media-body">
                                          <p>
                                              {{ $setting->phone_one }}<br>
                                              {{ $setting->phone_two }}<br>
                                          </p>
                                      </div>
                                  @endif
