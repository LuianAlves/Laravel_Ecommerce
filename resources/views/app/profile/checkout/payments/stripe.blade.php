    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li>
                    <a href="#">{{ session()->get('language') == 'portuguese' ? 'Stripe' : 'Stripe' }}</a>
                </li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51JhuSuARQi1vsitRxAY7TFDutzgWBa0hBDYDKUCUb5Rap9XfygOT3BGaiatXLaHd47tmSkME94MHfyok2t4qBmfu00hgLwii0J');
