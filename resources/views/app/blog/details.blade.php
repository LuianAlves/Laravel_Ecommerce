...
@section('title')
    Blog - {{ session()->get('language') == 'portuguese' ? $blog_post->post_title_pt : $blog_post->post_title_en }}
@endsection
            ...
            <div class="blog-page">
                <div class="col-md-9">
                    <div class="blog-post wow fadeInUp">
                        ...
                        <h1>{{ session()->get('language') == 'portuguese' ? $blog_post->post_title_pt : $blog_post->post_title_en }}</h1>
                        <span class="author">John Doe</span>
                        <span class="review">7 Comments</span>
                        <span class="date-time">{{ Carbon\Carbon::parse($blog_post->created_at)->diffForHumans() }}</span>
                        <p>{!! session()->get('language') == 'portuguese' ? $blog_post->post_details_pt : $blog_post->post_details_en !!}</p>
