                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($order->return_order == 2)
                                                    <span class="badge badge-pill text-white" style="background: #008000; font-weight: bold;">Return Sucessfully</span>
                                                @endif
                                            </td>
                                            {{-- Action --}}
                                            <td width="15%" class="text-center">
                                                ...
                                                @else
                                                    <span class="badge badge-info">Order Returned</span>
                                                @endif
                                            </td>
                                        </tr>   
                                    @endforeach
